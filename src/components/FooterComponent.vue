<template>
    <footer class="footer">
        ...
        <div class="footer__links">
            ...
            <p class="footer__links-list__item">About Us</p>
            <p class="footer__links-list__item">Contact</p>
            <p class="footer__links-list__item">Blog</p>
            <p class="footer__links-list__item">Careers</p>
            <p class="footer__links-list__item">Support</p>
